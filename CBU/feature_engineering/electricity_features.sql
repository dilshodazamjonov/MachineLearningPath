...
SELECT
    ...
    PERCENTILE_CONT(0.5) WITHIN GROUP (ORDER BY consumed_kwh) OVER w_3m AS elec_consumed_median_m3,
    ...
    PERCENTILE_CONT(0.5) WITHIN GROUP (ORDER BY consumed_kwh) OVER w_6m AS elec_consumed_median_m6,
    ...
    PERCENTILE_CONT(0.5) WITHIN GROUP (ORDER BY consumed_kwh) OVER w_9m AS elec_consumed_median_m9,
    ...
    PERCENTILE_CONT(0.5) WITHIN GROUP (ORDER BY consumed_kwh) OVER w_12m AS elec_consumed_median_m12,
    ...
    PERCENTILE_CONT(0.5) WITHIN GROUP (ORDER BY payment) OVER w_3m AS elec_payment_median_m3,
    ...
    PERCENTILE_CONT(0.5) WITHIN GROUP (ORDER BY payment) OVER w_6m AS elec_payment_median_m6,
    ...
    PERCENTILE_CONT(0.5) WITHIN GROUP (ORDER BY payment) OVER w_9m AS elec_payment_median_m9,
    ...
    PERCENTILE_CONT(0.5) WITHIN GROUP (ORDER BY payment) OVER w_12m AS elec_payment_median_m12,
    ...
    PERCENTILE_CONT(0.5) WITHIN GROUP (ORDER BY arrears) OVER w_3m AS elec_arrears_median_m3,
    ...
    PERCENTILE_CONT(0.5) WITHIN GROUP (ORDER BY arrears) OVER w_6m AS elec_arrears_median_m6,
    ...
    PERCENTILE_CONT(0.5) WITHIN GROUP (ORDER BY arrears) OVER w_9m AS elec_arrears_median_m9,
    ...
    PERCENTILE_CONT(0.5) WITHIN GROUP (ORDER BY arrears) OVER w_12m AS elec_arrears_median_m12,
    ...
    PERCENTILE_CONT(0.5) WITHIN GROUP (ORDER BY arrears - arrears_lag1) OVER w_3m AS elec_darrears_median_m3,
    ...
    PERCENTILE_CONT(0.5) WITHIN GROUP (ORDER BY arrears - arrears_lag1) OVER w_6m AS elec_darrears_median_m6,
    ...
    PERCENTILE_CONT(0.5) WITHIN GROUP (ORDER BY arrears - arrears_lag1) OVER w_9m AS elec_darrears_median_m9,
    ...
    PERCENTILE_CONT(0.5) WITHIN GROUP (ORDER BY arrears - arrears_lag1) OVER w_12m AS elec_darrears_median_m12,
    ...
    PERCENTILE_CONT(0.5) WITHIN GROUP (ORDER BY implied_bill) OVER w_3m AS elec_bill_implied_median_m3,
    ...
    PERCENTILE_CONT(0.5) WITHIN GROUP (ORDER BY implied_bill) OVER w_6m AS elec_bill_implied_median_m6,
    ...
    PERCENTILE_CONT(0.5) WITHIN GROUP (ORDER BY implied_bill) OVER w_9m AS elec_bill_implied_median_m9,
    ...
    PERCENTILE_CONT(0.5) WITHIN GROUP (ORDER BY implied_bill) OVER w_12m AS elec_bill_implied_median_m12,
    ...
    PERCENTILE_CONT(0.5) WITHIN GROUP (ORDER BY coverage) OVER w_3m AS elec_coverage_median_m3,
    ...
    PERCENTILE_CONT(0.5) WITHIN GROUP (ORDER BY coverage) OVER w_6m AS elec_coverage_median_m6,
    ...
    PERCENTILE_CONT(0.5) WITHIN GROUP (ORDER BY coverage) OVER w_9m AS elec_coverage_median_m9,
    ...
    PERCENTILE_CONT(0.5) WITHIN GROUP (ORDER BY coverage) OVER w_12m AS elec_coverage_median_m12,
    ...
    PERCENTILE_CONT(0.5) WITHIN GROUP (ORDER BY payment / NULLIF(consumed_kwh,0)) OVER w_3m AS elec_pay_per_kwh_median_m3,
    ...
    PERCENTILE_CONT(0.5) WITHIN GROUP (ORDER BY payment / NULLIF(consumed_kwh,0)) OVER w_6m AS elec_pay_per_kwh_median_m6,
    ...
    PERCENTILE_CONT(0.5) WITHIN GROUP (ORDER BY pay_per_kwh) OVER w_6m AS elec_pay_per_kwh_median_m6,
    ...
    PERCENTILE_CONT(0.5) WITHIN GROUP (ORDER BY pay_per_kwh) OVER w_9m AS elec_pay_per_kwh_median_m9,
    ...
    PERCENTILE_CONT(0.5) WITHIN GROUP (ORDER BY pay_per_kwh) OVER w_12m AS elec_pay_per_kwh_median_m12,
    ...
    PERCENTILE_CONT(0.5) WITHIN GROUP (ORDER BY bill_per_kwh) OVER w_3m AS elec_bill_per_kwh_median_m3,
    ...
    PERCENTILE_CONT(0.5) WITHIN GROUP (ORDER BY bill_per_kwh) OVER w_6m AS elec_bill_per_kwh_median_m6,
    ...
    PERCENTILE_CONT(0.5) WITHIN GROUP (ORDER BY bill_per_kwh) OVER w_9m AS elec_bill_per_kwh_median_m9,
    ...
    PERCENTILE_CONT(0.5) WITHIN GROUP (ORDER BY bill_per_kwh) OVER w_12m AS elec_bill_per_kwh_median_m12,
    ...
    PERCENTILE_CONT(0.5) WITHIN GROUP (ORDER BY arrears_per_kwh) OVER w_3m AS elec_arrears_per_kwh_median_m3,
    ...
    PERCENTILE_CONT(0.5) WITHIN GROUP (ORDER BY arrears_per_kwh) OVER w_6m AS elec_arrears_per_kwh_median_m6,
    ...
    PERCENTILE_CONT(0.5) WITHIN GROUP (ORDER BY arrears_per_kwh) OVER w_9m AS elec_arrears_per_kwh_median_m9,
    ...
    PERCENTILE_CONT(0.5) WITHIN GROUP (ORDER BY arrears_per_kwh) OVER w_12m AS elec_arrears_per_kwh_median_m12,
